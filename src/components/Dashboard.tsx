...
export default function Dashboard() {
  ...
  if (loading || usageLoading) {
    return (
      <div className="h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 flex justify-center items-center">
    ...
    <>
      <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 p-4">
        <div className="max-w-6xl mx-auto space-y-6">
          ...
          {usageStatus &&
            shouldShowUsageWarning(usageStatus) &&
            !shouldShowUpgradePrompt(usageStatus) && (
              <div className="flex justify-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {stories.map((story) => {
                ...
                return (
                  <Card
                    key={story.id}
                    className="p-0 m-0 shadow-lg hover:shadow-xl transition-shadow cursor-pointer group"
